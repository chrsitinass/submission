...
Feature-based methods usually rely on a variety of elaborately features. They aim to exploit different feature extraction strategies and evaluate feature contributions to the classification. Ahn \shortcite{ahn2006stages} formulate event extraction as a pipeline of four classification tasks and utilizes lexical features (e.g., full word), syntactic features (e.g., dependency features), and external-knowledge features (e.g., WordNet). Later studies intend to capture different levels of features. Ji and Grishman \shortcite{ji2008refining} combine global evidence from a cluster of related documents. Gupta and Ji \shortcite{gupta2009predicting} employ cross-event features, while Hong et al. \shortcite{hong2011using} leverage cross-entity inference to event extraction. Li et al. \shortcite{li2013joint} jointly learn trigger labeling and argument labeling using structured perceptron to capture both local and global features of triggers and arguments. 
